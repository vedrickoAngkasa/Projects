...
//Our class computer extends from the super class AppCompactActivity
    ...
    private void executeGame(View view){                //This method is used to execute the game functionality
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            if(winner==1){
                ...
                message.setText("Player Computer wins");
            ...
            if(!gameEnds){
                if(playerTurn=='X'){
                    ...
                    int random_int1 = random.nextInt(cellsLandscape.getRow());
                    int random_int2 = random.nextInt(cellsLandscape.getCol());

                    message.setText("Player Computer choose:\n"  +"Row : " +random_int1+ "Column: " +random_int2);

                    cellsLandscape.set(random_int1, random_int2, playerTurn);
            ...
            if(!gameEnds){
                if(playerTurn=='X'){
                    playerTurn='O';
                    Random random = new Random();
                    int random_int1 = random.nextInt(cellsPortrait.getRow());
                    int random_int2 = random.nextInt(cellsPortrait.getCol());

                    message.setText("Player Computer choose:\n"  +"Row : " +random_int1+ "Column: " +random_int2);

                    cellsPortrait.set(random_int1, random_int2, playerTurn);

...
public class CappucinnoActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drinnkName.setText("Cappucinno");
        imageView.setImageResource(R.drawable.cappcunio);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CappucinnoActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(CappucinnoActivity.this, "Please order more than 1 Thank you!", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
    ...
    private boolean SaveCart() {
        ...
        if (quantity <= 0){
            Toast.makeText(CappucinnoActivity.this, "Please order at least one or more.", Toast.LENGTH_SHORT).show();
        } else {

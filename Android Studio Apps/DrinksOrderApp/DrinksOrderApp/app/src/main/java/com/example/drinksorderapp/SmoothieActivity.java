...
public class SmoothieActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(SmoothieActivity.this, "Please order more than 1 Thank you!", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
    ...
    private boolean SaveCart() {
        ...
        if (quantity <= 0){
            Toast.makeText(SmoothieActivity.this, "Please order at least one or more.", Toast.LENGTH_SHORT).show();
        } else {

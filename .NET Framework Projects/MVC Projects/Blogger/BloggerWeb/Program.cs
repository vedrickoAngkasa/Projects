...
options.UseSqlServer(builder.Configuration.GetConnectionString("BloggerAuthDbConnectionString")));
...
builder.Services.AddScoped<IImageRepository, ClodinaryImageRepository>();

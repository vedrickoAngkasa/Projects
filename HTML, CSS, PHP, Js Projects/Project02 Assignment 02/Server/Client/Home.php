...
<body>
        ...
        <header>
            ...
            <div class="headerContent ">
       		...
       		<div class = "search">	
			<form class="formSearch" action="js/php/search.php" method="POST" onsubmit = "validateSearch()">
		...
		<div class="page p1" id="page1">
			 <main class="homeMain ">
                ...
                <div class="mainContent">
                    ...
                    <div class="title2">
                        <span class="Title2Text">OUR BEST SELLER </span>
                        <br/>
                        ...
                        <div class="card__container">
                            <div class="card__top__section">
                                ...
                                <div class="card__top__section__icons">
                                    ...
                                    <div>
                                       <input type="button" value="Cart" id = "Cart1" onclick="addtoCart();">
                                    </div>
                      ...
                      <div class="card__container">
                            <div class="card__top__section">
                                <img src="" id="img2">
                                    ...
                                    <div>
                                       <input type="button" value="Cart" id = "Cart2" onclick="addtoCart();">
                                    </div>
                        ...
                        <div class="card__container">
                            <div class="card__top__section">
                                ...
                                <div class="card__top__section__icons">
                                    ...
                                    <div>
                                       <input type="button" value="Cart" id = "Cart3" onclick="addtoCart();">
                                    </div>
                        ...
                        <div class="card__container">
                            <div class="card__top__section">
                                ...
                                <div class="card__top__section__icons">
                                    ...
                                    <div>
                                       <input type="button" value="Cart" id = "Cart4" onclick="addtoCart();">
                                    </div>
                        ...
                        <div class="card__container">
                            <div class="card__top__section">
                                ...
                                <div class="card__top__section__icons">
                                    ...
                                    <div>
                                       <input type="button" value="Cart" id = "Cart5" onclick="addtoCart();">
                                    </div>
                        ...
                        <div class="card__container">
                            <div class="card__top__section">
                                ...
                                <div class="card__top__section__icons">
                                    ...
                                    <div>
                                       <input type="button" value="Cart" id = "Cart6" onclick="addtoCart();">
                                    </div>
			...
			<span>LEGO SETS</span></a> </li>
                ...
                <div class="filter">
                    <select name="filter">
                        ...
                        <option value="Smallest Price">Smallest Price</option>
                    </select>
                </div>
        ...
        <div class="page p4" id="page4">
			<main class="loginMain">
                ...
                <div class="formContent" >
                    <h1>LOGIN</h1>
                   <form method= "POST" action="js/php/login.php">
